        ...
        if self.score:
            if not self.step.action is None:
                ...
                if(self.step.state.is_terminal):
                    ...
                    s ="〔score {}〕\nmax:{}\nmin:{}\n{}".format(self.score,main_player,other_player,self.step.state.ascii)
                    return s
        else:
            return ""

    def style(self,main_player):
        format_str = NodeBase.style(self,main_player)
...
class TreeMinmax(Tree):
    ...
    def __init__(self,root=None,main_player="a"):
        ...
        super().__init__(root,main_player,NodeMinmax)
