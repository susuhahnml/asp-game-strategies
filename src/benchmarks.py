...
if __name__ == "__main__":
    ...
    for g in game_names:
        ...
        for i,n in initial_names:
            print(paint("\tInitial: {}".format(i),bcolors.HEADER))
            for p_a in players:
                command = "python main.py vs  --log=error --n={} --game-name={} --init=initial_{}.lp --out=r_VS_{}_in_{}.json --play-symmetry --a=random --b={}".format(n,g,i,p_a,i,p_a)
                run(command)